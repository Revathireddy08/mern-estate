...
export default function Search() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      setSidebardata({
        ...
        sort: sortFromUrl || "createdAt", // ✅ FIXED
  ...
  const onShowMoreClick = async () => {
    ...
    const res = await fetch(
      `https://mern-estate-backend-iz4a.onrender.com/api/listing/get?${urlParams.toString()}`
    );
